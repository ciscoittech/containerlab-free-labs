...
echo "    router-b1: docker exec -it clab-enterprise-vpn-migration-router-b1 vtysh"
echo "    router-b2: docker exec -it clab-enterprise-vpn-migration-router-b2 vtysh"
echo ""
