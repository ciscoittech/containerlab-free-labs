...
echo "  Management Network: 172.20.25.0/24"
echo ""
...
echo "    router-a1:      ssh -p 2231 admin@localhost  # Password: cisco"
echo "    router-a2:      ssh -p 2232 admin@localhost"
echo "    router-b1:      ssh -p 2233 admin@localhost"
echo "    router-b2:      ssh -p 2234 admin@localhost"
echo "    internet-core:  ssh -p 2235 admin@localhost"
echo ""
