...
echo "  ssh -p 2211 cisco@localhost  # r1 (AS 100)"
echo "  ssh -p 2212 cisco@localhost  # r2 (AS 200)"
echo "  ssh -p 2213 cisco@localhost  # r3 (AS 300)"
echo "  ssh -p 2214 cisco@localhost  # r4 (AS 100)"
echo "  Password: cisco"
echo ""
